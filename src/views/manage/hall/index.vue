<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="hallList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="影厅编号" align="center" prop="hallNumber" />
      <el-table-column label="影厅名" align="center" prop="name" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="影厅名" prop="name">
          <el-input v-model="form.name" placeholder="请输入影厅名" />
        </el-form-item>
      </el-form>
...
<script>
import { listHall, getHall, delHall, addHall, updateHall } from "@/api/manage/hall";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        cinemaName: [
          { required: true, message: "影院名称不能为空", trigger: "change" }
        ],
        hallNumber: [
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('manage/hall/export', {
        ...this.queryParams
